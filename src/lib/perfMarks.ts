 ...
 */
export const MARK = {
  resultPage: "trinocular:result:page",
  resultSettled: "trinocular:result:settled",
  editorChange: "trinocular:editor:change",
  inspectorRendered: "trinocular:inspector:rendered"
} as const;
